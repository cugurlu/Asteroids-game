...
public class Asteroid extends GameObject {
    ...
    public Asteroid(Random random) {
        ...
        this.rotationSpeed = -Constants.MINIMUM_ROTATION
                + (random.nextDouble() * Constants.DIFFERENCE_IN_ROTATION);
    ...
    private static Vector calculatePosition(Random random) {
        ...
        Vector positionVector = resultVector.scaleBy(
                Constants.MINIMUM_TRAVEL_DISTANCE
                        + random.nextDouble() * Constants.TRAVEL_DISTANCE_DIFFERENCE);
