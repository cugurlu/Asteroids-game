...
public abstract class Controller {
    ...
    static void drawDropMenu(AnchorPane anchor, Pane controls, Pane vol, Pane quit) {
        ...
        BackgroundImage controller = new BackgroundImage(
                new Image(c.toURI().toString(),19,
                        23,false,true),
        ...
        BackgroundImage volume = new BackgroundImage(
                new Image(v.toURI().toString(),18,
                        15,true,true),
                BackgroundRepeat.NO_REPEAT,
                BackgroundRepeat.NO_REPEAT,
                BackgroundPosition.DEFAULT,
        ...
        BackgroundImage x = new BackgroundImage(
                new Image(d.toURI().toString(),15,
                        15,true,true),
                BackgroundRepeat.NO_REPEAT,
                BackgroundRepeat.NO_REPEAT,
                BackgroundPosition.DEFAULT,
     ...
     * @param zero whether to lower or raise menu.
     * @param mid the middle bar of the menu.
     * @param controls the controls button.
     * @param bot the bottom bar of the menu.
     * @param vol the volume button.
     * @param quit the back button.
     * @return the animated menu bar.
     */
    ...
    /**
     * when users hovers, the button lights up.
     * @param btn the button to light up.
     */
    ...
    /**
     * removes lightup effect from hovered buttons.
     * @param btn the button to be darkened.
     */
